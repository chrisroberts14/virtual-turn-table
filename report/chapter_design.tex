...
Figure~\ref{fig:social_screen_mockup} depicts the social screen, where users can view collections belonging to others whether shared directly with them or made public. This feature aimed to add a sense of social interaction among users and allow for the discovery of new music.
